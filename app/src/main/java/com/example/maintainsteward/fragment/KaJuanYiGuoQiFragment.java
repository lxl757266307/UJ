...
public class KaJuanYiGuoQiFragment extends Fragment implements PtrHandler2, KaJuanListener, KaJuanListAdapter.OnKaJuanItemClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        kaJuanListAdapter = new KaJuanListAdapter(getActivity(),1);
