...
public class SetPayPasswordActivity extends BaseActivity implements OnUpdatePayPasswordListener, LoginListener {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.txt_send_yan_zheng_ma: {
                ...
                loginPresonter.getCode(phone, "4", timeStamp, sign, Contacts.KEY);
