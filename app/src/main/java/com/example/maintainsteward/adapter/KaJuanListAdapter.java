...
public class KaJuanListAdapter extends BaseAbstactRecycleAdapter<KaJuanBean.DataBean.ResultDataBean, KaJuanListAdapter.ViewHolder> {

    Context context;
    public static final String TAG = "KaJuanListAdapter";
    int statusCode;

    public KaJuanListAdapter(Context context, int statusCode) {
        this.context = context;
        this.statusCode = statusCode;
    }

    @Override
    public void getViewHolder(ViewHolder baseViewHolder, final int position, List<KaJuanBean.DataBean.ResultDataBean> mList) {

        KaJuanBean.DataBean.ResultDataBean resultDataBean = mList.get(position);
