...
public class LoginCallBackBean {
    ...
    /**
     * status : 1
     * data : {"id":"360","user_login":"15769362635","user_pass":"","user_phone":"15769362635","paypwd":"","is_set_paypwd":"0","user_nicename":"15769362635","user_name":"","user_email":"","avatar":"","sex":"0","birthday":"0000-00-00","last_login_ip":"","last_login_time":"2017-09-07 14:21:33","create_time":"2017-09-07 14:21:33","user_activation_key":"","user_status":"1","user_balance":"0.00","score":"0","earn_points":"0","user_type":"2","yqm":"fee38719","parentid":"0","is_vip":"0","open_id":"","access_token":"","qrcode":"","focuse_num":"0","operate":"0","follow_type":"0","commission_money":"0","commission_balance":"0","topid":"0"}
     */
    ...
    public static LoginCallBackBean objectFromData(String str) {
        ...
        return new Gson().fromJson(str, LoginCallBackBean.class);
    }

    public static LoginCallBackBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), LoginCallBackBean.class);
    ...
    public static List<LoginCallBackBean> arrayLoginCallBackBeanFromData(String str) {
        ...
        Type listType = new TypeToken<ArrayList<LoginCallBackBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<LoginCallBackBean> arrayLoginCallBackBeanFromData(String str, String key) {
    ...
    public static class DataBean {
        ...
        /**
         * id : 360
         * user_login : 15769362635
         * user_pass :
         * user_phone : 15769362635
         * paypwd :
         * is_set_paypwd : 0
         * user_nicename : 15769362635
         * user_name :
         * user_email :
         * avatar :
         * sex : 0
         * birthday : 0000-00-00
         * last_login_ip :
         * last_login_time : 2017-09-07 14:21:33
         * create_time : 2017-09-07 14:21:33
         * user_activation_key :
         * user_status : 1
         * user_balance : 0.00
         * score : 0
